...
var trex2, trex2_running, trex2_collided;
...
function preload(){
  ...
  trex2_running = loadAnimation("trex1.png","trex3.png","trex4.png");
...
function setup() {
 ...
 console.log(message)
  ...
  trex2 = createSprite(20,160,20,50);
  ...
  trex2.setCollider("rectangle",0,0,trex.width,trex.height);
  trex.debug = true
  trex2.debug = true
  score = 0;
